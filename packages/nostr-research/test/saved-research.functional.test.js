...
test('recorded query becomes an explainable, expandable, combinable durable research path', () => {
  ...
  try {
    const run = cli(database, 'run', 'search', '--id', reply.id);
