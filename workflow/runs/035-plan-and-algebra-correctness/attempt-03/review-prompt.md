...
- Corrected the functional test to call `context.close()` instead of nonexistent `context.cleanup()`.

Validation:
- Task validation script passed.
- Syntax checks passed.
- Test suite: 18 passed, 15 environment-skipped, 0 failed.
...
(node:77303) Warning: Setting the NODE_TLS_REJECT_UNAUTHORIZED environment variable to '0' makes TLS connections and HTTPS requests insecure by disabling certificate verification.
(Use `node --trace-warnings ...` to show where the warning was created)
✔ public acquisition handles NIP-01 outcomes, validation, deduplication, provenance, and closure (140.606375ms)
✔ account hydration derives a bounded metadata filter from account subjects (51.181459ms)
✔ a named public plan composes bounded acquisition, algebra, hydration, and retention (98.859708ms)
✔ plan preflight rejects retention of value collections before acquisition starts (81.324125ms)
✔ global limit and cancellation are distinguishable and close owned sockets (155.171625ms)
✔ distinct-event budget ignores duplicate observations while observation budget stays hard (121.671667ms)
✔ canonical relay events outside the requested filter are diagnosed without ingestion (137.124959ms)
✔ timeout force-closes a peer that ignores the WebSocket closing handshake (187.821542ms)
✔ timeout and partial connection failure remain observable (223.901583ms)
✔ acquisition rejects unusable public inputs before networking (0.435708ms)
✔ console expansion rejects invalid bounds and semantics before networking (0.51325ms)
...
✔ authored-note expansion samples only explicit account starts within per-account and global bounds (135.269667ms)
✔ authored-note expansion obeys the complete operation budget and stays disabled by default (57.06925ms)
✔ expansion reuses distinct capacity when a later request repeats an earlier event (40.79475ms)
...
✔ bounded reply contexts resolve direct NIP-10 parents with provenance and explicit gaps (110.181083ms)
...
✔ console expansion performs bounded targeted multi-hop acquisition (96.118166ms)
✔ exported expansion uses the global budget for reply breadth and preserves tiny-corpus seeds (158.50275ms)
✔ typed local stages refine, balance, summarize, and move trial-shaped evidence (33.492917ms)
✔ empty paths retain typed context and invalid plans fail before execution (0.689292ms)
✔ bounded groups expose exact membership, refresh evidence, and summarize exact counts (18.90675ms)
✔ a local-only named plan can query resident memory without implicit acquisition (0.544209ms)
✔ one console process preserves JavaScript state and composes a bounded research loop (279.812584ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (25.832125ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (35.606625ms)
✔ process-local memory preserves canonical evidence and independent relay observations (43.38425ms)
✔ presentation and facets orient surviving research values (50.006542ms)
✔ replaceable selection and follow interpretation remain stable in one process (50.637ms)
✔ public local search composes constraints, explains matches, and preserves provenance (41.505042ms)
✔ current account metadata uses replaceable semantics and profile search returns source evidence (31.184125ms)
✔ large retention is atomic, bounded, process-local, and directly navigable (2287.854375ms)
✔ selection, bounded traversal, projection, retention, and continuation compose (28.605958ms)
✔ a session only changes active selection explicitly and checkpoints it process-locally (32.681709ms)
✔ retained reactivation does not recreate evicted canonical evidence (6.305209ms)
ℹ tests 33
ℹ suites 0
ℹ pass 33
ℹ fail 0
