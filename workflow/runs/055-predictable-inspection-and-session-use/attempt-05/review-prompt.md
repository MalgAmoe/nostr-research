...
The previous substantive discovery finding remains for hydration-report handles. `discoverResearchOperations()` recommends `pick`, `relate`, `remember-membership`, and `move` for `{ kind: "events", resultKind: "hydration-report" }`, while `descriptorCollection()` explicitly rejects hydration reports. Thus contextual discovery still advertises operations that preflight will reject.

Because this is the same invalid-operation discovery defect after another worker attempt, the workflow requires reassessment rather than a third mechanical correction.
...
✔ acquisition rejects unusable public inputs before networking (1.344125ms)
✔ direct, plan, and session execution share operation kinds and failure boundaries (44.597042ms)
✔ collections navigate identities while relations own value analysis (19.43925ms)
✔ named account and note handles continue with bounded relationship provenance (2229.5395ms)
✔ declarative observation and lifecycle form one bounded public workflow (52.145042ms)
✔ declarative named results compose compatible sets and expose their schema (7.622416ms)
✔ declarative notebook knowledge survives turnover and remains independent from evidence (11.701917ms)
✔ explicit archive preservation survives complete buffer turnover and releases atomically (68.70175ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (42.882583ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (24.401375ms)
✔ JSONL executable provides one persistent bounded process workflow (85.591167ms)
✔ process-local memory preserves canonical evidence and independent relay observations (36.23125ms)
✔ replaceable selection and follow interpretation remain stable in one process (56.441ms)
✔ public local search composes constraints, explains matches, and preserves provenance (22.779125ms)
✔ relation handles resolve references across evidence lifetime and keep bounded views composable (45.444292ms)
✔ large notebook membership is atomic, bounded, process-local, and directly navigable (2248.804417ms)
ℹ tests 16
ℹ suites 0
ℹ pass 16
ℹ fail 0
