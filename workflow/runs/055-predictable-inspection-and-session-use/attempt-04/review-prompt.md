...
✔ acquisition rejects unusable public inputs before networking (0.960958ms)
✔ direct, plan, and session execution share operation kinds and failure boundaries (32.779167ms)
✔ collections navigate identities while relations own value analysis (11.579292ms)
✔ named account and note handles continue with bounded relationship provenance (2222.76575ms)
✔ declarative observation and lifecycle form one bounded public workflow (32.451458ms)
✔ declarative named results compose compatible sets and expose their schema (11.750958ms)
✔ declarative notebook knowledge survives turnover and remains independent from evidence (14.449542ms)
✔ explicit archive preservation survives complete buffer turnover and releases atomically (75.514625ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (30.912125ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (21.21675ms)
✔ JSONL executable provides one persistent bounded process workflow (104.476792ms)
✔ process-local memory preserves canonical evidence and independent relay observations (33.637417ms)
✔ replaceable selection and follow interpretation remain stable in one process (57.679667ms)
✔ public local search composes constraints, explains matches, and preserves provenance (25.213334ms)
✔ relation handles resolve references across evidence lifetime and keep bounded views composable (43.710834ms)
✔ large notebook membership is atomic, bounded, process-local, and directly navigable (2238.1595ms)
ℹ tests 16
ℹ suites 0
ℹ pass 16
ℹ fail 0
