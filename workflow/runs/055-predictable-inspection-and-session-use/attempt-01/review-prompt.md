...
✔ acquisition rejects unusable public inputs before networking (2.483042ms)
✔ direct, plan, and session execution share operation kinds and failure boundaries (33.76175ms)
✔ collections navigate identities while relations own value analysis (12.990375ms)
✔ named account and note handles continue with bounded relationship provenance (2225.539708ms)
✔ declarative observation and lifecycle form one bounded public workflow (40.942458ms)
✔ declarative named results compose compatible sets and expose their schema (6.293708ms)
✔ declarative notebook knowledge survives turnover and remains independent from evidence (20.029875ms)
✔ explicit archive preservation survives complete buffer turnover and releases atomically (79.948042ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (29.969917ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (35.811708ms)
✔ JSONL executable provides one persistent bounded process workflow (105.834583ms)
✔ process-local memory preserves canonical evidence and independent relay observations (27.154708ms)
✔ replaceable selection and follow interpretation remain stable in one process (59.580166ms)
✔ public local search composes constraints, explains matches, and preserves provenance (25.688541ms)
✔ relation handles resolve references across evidence lifetime and keep bounded views composable (44.888416ms)
✔ large notebook membership is atomic, bounded, process-local, and directly navigable (2253.274125ms)
ℹ tests 16
ℹ suites 0
ℹ pass 16
ℹ fail 0
