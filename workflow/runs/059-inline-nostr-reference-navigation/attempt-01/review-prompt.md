...
✔ acquisition rejects unusable public inputs before networking (0.992291ms)
✔ address subjects navigate typed references to current local replaceable evidence (91.860875ms)
✔ ordinary acquisition accepts an explicit canonical #a filter (0.37725ms)
✔ direct, plan, and session execution share operation kinds and failure boundaries (42.163291ms)
✔ collections navigate identities while relations own value analysis (23.351625ms)
✔ named account and note handles continue with bounded relationship provenance (2251.839584ms)
✔ factual schemas construct commands accepted through the public session seam (56.389709ms)
✔ declarative observation and lifecycle form one bounded public workflow (41.322667ms)
✔ relation summaries compact source selection details without losing their shape (6.434167ms)
✔ declarative named results compose compatible sets and expose their schema (14.425583ms)
✔ declarative notebook knowledge survives turnover and remains independent from evidence (28.315125ms)
✔ explicit archive preservation survives complete buffer turnover and releases atomically (70.782916ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (33.834208ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (36.334875ms)
✔ JSONL executable provides one persistent bounded process workflow (110.986041ms)
✔ process-local memory preserves canonical evidence and independent relay observations (26.452167ms)
✔ public references normalize to stable subjects while hints stay attributed metadata (3.438625ms)
✔ mixed event kinds derive truthful references without polluting conversations (48.526958ms)
✔ inline NIP-27 references navigate as typed, explainable evidence without becoming threads (5.445375ms)
✔ replaceable selection and follow interpretation remain stable in one process (24.772166ms)
✔ public local search composes constraints, explains matches, and preserves provenance (26.061458ms)
✔ relation handles resolve references across evidence lifetime and keep bounded views composable (57.966458ms)
✔ large notebook membership is atomic, bounded, process-local, and directly navigable (2237.659166ms)
ℹ tests 23
ℹ suites 0
ℹ pass 23
ℹ fail 0
