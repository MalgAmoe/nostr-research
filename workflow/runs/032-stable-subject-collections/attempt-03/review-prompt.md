...
(node:61807) Warning: Setting the NODE_TLS_REJECT_UNAUTHORIZED environment variable to '0' makes TLS connections and HTTPS requests insecure by disabling certificate verification.
(Use `node --trace-warnings ...` to show where the warning was created)
✔ public acquisition handles NIP-01 outcomes, validation, deduplication, provenance, and closure (123.364209ms)
✔ account hydration derives a bounded metadata filter from account subjects (78.841375ms)
✔ global limit and cancellation are distinguishable and close owned sockets (96.745458ms)
✔ distinct-event budget ignores duplicate observations while observation budget stays hard (124.672917ms)
✔ canonical relay events outside the requested filter are diagnosed without ingestion (62.090375ms)
✔ timeout force-closes a peer that ignores the WebSocket closing handshake (121.520417ms)
✔ timeout and partial connection failure remain observable (194.271292ms)
✔ acquisition rejects unusable public inputs before networking (0.545791ms)
✔ console expansion rejects invalid bounds and semantics before networking (0.544375ms)
...
✔ authored-note expansion samples only explicit account starts within per-account and global bounds (160.13ms)
✔ authored-note expansion obeys the complete operation budget and stays disabled by default (90.271083ms)
✔ expansion reuses distinct capacity when a later request repeats an earlier event (57.083375ms)
...
✔ bounded reply contexts resolve direct NIP-10 parents with provenance and explicit gaps (108.995542ms)
...
✔ console expansion performs bounded targeted multi-hop acquisition (78.855375ms)
✔ exported expansion uses the global budget for reply breadth and preserves tiny-corpus seeds (92.462ms)
✔ one console process preserves JavaScript state and composes a bounded research loop (285.332041ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (37.547042ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (32.143875ms)
✔ process-local memory preserves canonical evidence and independent relay observations (37.841417ms)
✔ presentation and facets orient surviving research values (42.762667ms)
✔ replaceable selection and follow interpretation remain stable in one process (59.826208ms)
✔ public local search composes constraints, explains matches, and preserves provenance (37.164292ms)
✔ current account metadata uses replaceable semantics and profile search returns source evidence (24.381917ms)
✔ large retention is atomic, bounded, process-local, and directly navigable (2354.161666ms)
✔ selection, bounded traversal, projection, retention, and continuation compose (44.238291ms)
✔ a session only changes active selection explicitly and checkpoints it process-locally (25.908542ms)
✔ retained reactivation does not recreate evicted canonical evidence (7.974083ms)
ℹ tests 27
ℹ suites 0
ℹ pass 27
ℹ fail 0
