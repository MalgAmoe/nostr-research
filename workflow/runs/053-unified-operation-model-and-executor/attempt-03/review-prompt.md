...
✔ acquisition rejects unusable public inputs before networking (3.182583ms)
✔ direct, plan, and session execution share operation kinds and failure boundaries (28.912042ms)
✔ collections navigate identities while relations own value analysis (16.799542ms)
✔ named account and note handles continue with bounded relationship provenance (2221.327958ms)
✔ declarative observation and lifecycle form one bounded public workflow (40.486625ms)
✔ declarative named results compose compatible sets and expose their schema (8.2245ms)
✔ declarative notebook knowledge survives turnover and remains independent from evidence (13.354542ms)
✔ explicit archive preservation survives complete buffer turnover and releases atomically (62.293958ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (35.352583ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (20.964375ms)
✔ JSONL executable provides one persistent bounded process workflow (123.803958ms)
✔ process-local memory preserves canonical evidence and independent relay observations (43.207791ms)
✔ replaceable selection and follow interpretation remain stable in one process (55.287541ms)
✔ public local search composes constraints, explains matches, and preserves provenance (23.188167ms)
✔ relation handles resolve references across evidence lifetime and keep bounded views composable (45.144208ms)
✔ large notebook membership is atomic, bounded, process-local, and directly navigable (2229.833ms)
ℹ tests 16
ℹ suites 0
ℹ pass 16
ℹ fail 0
