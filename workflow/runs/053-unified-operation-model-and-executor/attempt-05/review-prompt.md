...
✔ acquisition rejects unusable public inputs before networking (0.989209ms)
✔ direct, plan, and session execution share operation kinds and failure boundaries (33.919791ms)
✔ collections navigate identities while relations own value analysis (10.949625ms)
✔ named account and note handles continue with bounded relationship provenance (2229.711292ms)
✔ declarative observation and lifecycle form one bounded public workflow (37.045208ms)
✔ declarative named results compose compatible sets and expose their schema (6.987084ms)
✔ declarative notebook knowledge survives turnover and remains independent from evidence (11.098875ms)
✔ explicit archive preservation survives complete buffer turnover and releases atomically (58.500625ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (32.849333ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (20.238916ms)
✔ JSONL executable provides one persistent bounded process workflow (114.025333ms)
✔ process-local memory preserves canonical evidence and independent relay observations (52.081084ms)
✔ replaceable selection and follow interpretation remain stable in one process (49.210792ms)
✔ public local search composes constraints, explains matches, and preserves provenance (23.514792ms)
✔ relation handles resolve references across evidence lifetime and keep bounded views composable (44.749916ms)
✔ large notebook membership is atomic, bounded, process-local, and directly navigable (2260.376ms)
ℹ tests 16
ℹ suites 0
ℹ pass 16
ℹ fail 0
