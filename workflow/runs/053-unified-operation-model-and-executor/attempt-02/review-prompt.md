...
✔ acquisition rejects unusable public inputs before networking (1.889542ms)
✔ direct, plan, and session execution share operation kinds and failure boundaries (24.458125ms)
✔ collections navigate identities while relations own value analysis (14.592375ms)
✔ named account and note handles continue with bounded relationship provenance (2180.289125ms)
✔ declarative observation and lifecycle form one bounded public workflow (45.547083ms)
✔ declarative named results compose compatible sets and expose their schema (6.390584ms)
✔ declarative notebook knowledge survives turnover and remains independent from evidence (15.272125ms)
✔ explicit archive preservation survives complete buffer turnover and releases atomically (57.257042ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (44.076042ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (29.617959ms)
✔ JSONL executable provides one persistent bounded process workflow (119.563333ms)
✔ process-local memory preserves canonical evidence and independent relay observations (39.049ms)
✔ replaceable selection and follow interpretation remain stable in one process (63.372042ms)
✔ public local search composes constraints, explains matches, and preserves provenance (24.261917ms)
✔ relation handles resolve references across evidence lifetime and keep bounded views composable (44.326209ms)
✔ large notebook membership is atomic, bounded, process-local, and directly navigable (2233.321625ms)
ℹ tests 16
ℹ suites 0
ℹ pass 16
ℹ fail 0
