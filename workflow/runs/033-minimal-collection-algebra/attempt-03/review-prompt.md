...
(node:66456) Warning: Setting the NODE_TLS_REJECT_UNAUTHORIZED environment variable to '0' makes TLS connections and HTTPS requests insecure by disabling certificate verification.
(Use `node --trace-warnings ...` to show where the warning was created)
✔ public acquisition handles NIP-01 outcomes, validation, deduplication, provenance, and closure (200.393542ms)
✔ account hydration derives a bounded metadata filter from account subjects (96.259208ms)
✔ global limit and cancellation are distinguishable and close owned sockets (177.469542ms)
✔ distinct-event budget ignores duplicate observations while observation budget stays hard (167.638875ms)
✔ canonical relay events outside the requested filter are diagnosed without ingestion (60.704334ms)
✔ timeout force-closes a peer that ignores the WebSocket closing handshake (141.338834ms)
✔ timeout and partial connection failure remain observable (178.110792ms)
✔ acquisition rejects unusable public inputs before networking (0.535834ms)
✔ console expansion rejects invalid bounds and semantics before networking (0.5195ms)
...
✔ authored-note expansion samples only explicit account starts within per-account and global bounds (142.234208ms)
✔ authored-note expansion obeys the complete operation budget and stays disabled by default (69.68975ms)
✔ expansion reuses distinct capacity when a later request repeats an earlier event (56.18725ms)
...
✔ bounded reply contexts resolve direct NIP-10 parents with provenance and explicit gaps (194.94625ms)
...
✔ console expansion performs bounded targeted multi-hop acquisition (131.264542ms)
✔ exported expansion uses the global budget for reply breadth and preserves tiny-corpus seeds (143.330834ms)
✔ typed local stages refine, balance, summarize, and move trial-shaped evidence (39.115208ms)
✔ empty paths retain typed context and invalid plans fail before execution (0.268084ms)
✔ one console process preserves JavaScript state and composes a bounded research loop (274.394333ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (39.315708ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (27.462ms)
✔ process-local memory preserves canonical evidence and independent relay observations (32.819917ms)
✔ presentation and facets orient surviving research values (48.013917ms)
✔ replaceable selection and follow interpretation remain stable in one process (56.47ms)
✔ public local search composes constraints, explains matches, and preserves provenance (35.159792ms)
✔ current account metadata uses replaceable semantics and profile search returns source evidence (25.044333ms)
✔ large retention is atomic, bounded, process-local, and directly navigable (2258.186916ms)
✔ selection, bounded traversal, projection, retention, and continuation compose (26.530708ms)
✔ a session only changes active selection explicitly and checkpoints it process-locally (29.598375ms)
✔ retained reactivation does not recreate evicted canonical evidence (6.257416ms)
ℹ tests 29
ℹ suites 0
ℹ pass 29
ℹ fail 0
