...
(node:70262) Warning: Setting the NODE_TLS_REJECT_UNAUTHORIZED environment variable to '0' makes TLS connections and HTTPS requests insecure by disabling certificate verification.
(Use `node --trace-warnings ...` to show where the warning was created)
✔ public acquisition handles NIP-01 outcomes, validation, deduplication, provenance, and closure (109.204333ms)
✔ account hydration derives a bounded metadata filter from account subjects (73.304334ms)
✔ a named public plan composes bounded acquisition, algebra, hydration, and retention (109.117167ms)
✔ global limit and cancellation are distinguishable and close owned sockets (190.994ms)
✔ distinct-event budget ignores duplicate observations while observation budget stays hard (98.67725ms)
✔ canonical relay events outside the requested filter are diagnosed without ingestion (65.677791ms)
✔ timeout force-closes a peer that ignores the WebSocket closing handshake (155.446791ms)
✔ timeout and partial connection failure remain observable (149.358375ms)
✔ acquisition rejects unusable public inputs before networking (0.536083ms)
✔ console expansion rejects invalid bounds and semantics before networking (0.521667ms)
...
✔ authored-note expansion samples only explicit account starts within per-account and global bounds (94.342292ms)
✔ authored-note expansion obeys the complete operation budget and stays disabled by default (55.814542ms)
✔ expansion reuses distinct capacity when a later request repeats an earlier event (68.596166ms)
...
✔ bounded reply contexts resolve direct NIP-10 parents with provenance and explicit gaps (216.330958ms)
...
✔ console expansion performs bounded targeted multi-hop acquisition (97.598792ms)
✔ exported expansion uses the global budget for reply breadth and preserves tiny-corpus seeds (97.340792ms)
✔ typed local stages refine, balance, summarize, and move trial-shaped evidence (48.128958ms)
✔ empty paths retain typed context and invalid plans fail before execution (0.251334ms)
✔ a local-only named plan can query resident memory without implicit acquisition (0.378792ms)
✔ one console process preserves JavaScript state and composes a bounded research loop (286.088125ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (27.335167ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (23.19775ms)
✔ process-local memory preserves canonical evidence and independent relay observations (32.797583ms)
✔ presentation and facets orient surviving research values (46.67475ms)
✔ replaceable selection and follow interpretation remain stable in one process (56.903375ms)
✔ public local search composes constraints, explains matches, and preserves provenance (45.296833ms)
✔ current account metadata uses replaceable semantics and profile search returns source evidence (25.192ms)
✔ large retention is atomic, bounded, process-local, and directly navigable (2250.987417ms)
✔ selection, bounded traversal, projection, retention, and continuation compose (25.823875ms)
✔ a session only changes active selection explicitly and checkpoints it process-locally (28.064959ms)
✔ retained reactivation does not recreate evicted canonical evidence (6.05075ms)
ℹ tests 31
ℹ suites 0
ℹ pass 31
ℹ fail 0
