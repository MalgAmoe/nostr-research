...
(node:39119) Warning: Setting the NODE_TLS_REJECT_UNAUTHORIZED environment variable to '0' makes TLS connections and HTTPS requests insecure by disabling certificate verification.
(Use `node --trace-warnings ...` to show where the warning was created)
✔ declarative session preserves handles, revisions, preflight, and partial outcomes (268.922916ms)
✔ public acquisition handles NIP-01 outcomes, validation, deduplication, and provenance (79.329791ms)
✔ account hydration derives a bounded metadata filter from account subjects (70.856125ms)
✔ a named public plan composes bounded acquisition, algebra, hydration, and retention (85.406458ms)
✔ plan preflight rejects retention of value collections before acquisition starts (31.877625ms)
✔ global limit and cancellation are distinguishable (61.686625ms)
✔ distinct-event budget ignores duplicate observations while observation budget stays hard (96.066833ms)
✔ canonical relay events outside the requested filter are diagnosed without ingestion (65.627833ms)
✔ timeout and partial connection failure remain observable (135.027417ms)
✔ acquisition rejects unusable public inputs before networking (0.410625ms)
✔ console expansion rejects invalid bounds and semantics before networking (0.481ms)
...
✔ authored-note expansion samples only explicit account starts within per-account and global bounds (99.923416ms)
✔ authored-note expansion obeys the complete operation budget and stays disabled by default (67.6585ms)
✔ expansion reuses distinct capacity when a later request repeats an earlier event (65.60925ms)
...
✔ bounded reply contexts resolve direct NIP-10 parents with provenance and explicit gaps (137.875458ms)
...
✔ console expansion performs bounded targeted multi-hop acquisition (94.869625ms)
✔ exported expansion uses the global budget for reply breadth and preserves tiny-corpus seeds (99.785542ms)
✔ typed local stages refine, balance, summarize, and move trial-shaped evidence (49.701125ms)
✔ empty paths retain typed context and invalid plans fail before execution (0.645792ms)
✔ bounded groups expose exact membership, refresh evidence, and summarize exact counts (18.354041ms)
✔ a local-only named plan can query resident memory without implicit acquisition (1.662875ms)
✔ stable bounds and compatible set composition share the public pipeline algebra (25.216708ms)
✔ pipeline schema exposes literal fields and preflight rejects invalid composition (3.0815ms)
✔ bounded groups preserve complete derived inputs and provenance for aggregation (10.966166ms)
✔ one console process preserves JavaScript state and composes a bounded research loop (323.983041ms)
✔ named account and note handles continue with bounded relationship provenance (2269.066666ms)
✔ declarative observation and lifecycle form one bounded public workflow (36.635292ms)
✔ declarative show bounds grouped and summarized named results (7.460375ms)
✔ declarative named results compose compatible sets and expose their schema (2.597041ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (29.269167ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (39.744708ms)
✔ JSONL executable provides one persistent bounded process workflow (102.390917ms)
✔ process-local memory preserves canonical evidence and independent relay observations (32.798667ms)
✔ presentation and facets orient surviving research values (56.005917ms)
✔ replaceable selection and follow interpretation remain stable in one process (47.058375ms)
✔ public local search composes constraints, explains matches, and preserves provenance (40.418291ms)
✔ current account metadata uses replaceable semantics and profile search returns source evidence (18.655291ms)
✔ large retention is atomic, bounded, process-local, and directly navigable (2310.384625ms)
✔ selection, bounded traversal, projection, retention, and continuation compose (39.981292ms)
✔ a session only changes active selection explicitly and checkpoints it process-locally (38.361791ms)
✔ retained reactivation does not recreate evicted canonical evidence (7.656916ms)
ℹ tests 41
ℹ suites 0
ℹ pass 41
ℹ fail 0
