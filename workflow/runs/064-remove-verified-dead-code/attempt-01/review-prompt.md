...
✔ acquisition rejects unusable public inputs before networking (1.135666ms)
✔ address subjects navigate typed references to current local replaceable evidence (116.012375ms)
✔ ordinary acquisition accepts an explicit canonical #a filter (0.535459ms)
✔ direct, plan, and session execution share operation kinds and failure boundaries (36.664417ms)
✔ collections navigate identities while relations own value analysis (17.911ms)
✔ named account and note handles continue with bounded relationship provenance (2348.126125ms)
✔ factual schemas construct commands accepted through the public session seam (53.679792ms)
✔ declarative observation and lifecycle form one bounded public workflow (50.821459ms)
✔ relation summaries compact source selection details without losing their shape (4.342166ms)
✔ declarative named results compose compatible sets and expose their schema (8.971916ms)
✔ declarative notebook knowledge survives turnover and remains independent from evidence (14.589417ms)
✔ explicit archive preservation survives complete buffer turnover and releases atomically (69.495041ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (49.768625ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (31.602791ms)
✔ JSONL executable provides one persistent bounded process workflow (121.801625ms)
✔ process-local memory preserves canonical evidence and independent relay observations (61.013625ms)
✔ public references normalize to stable subjects while hints stay attributed metadata (4.0705ms)
✔ mixed event kinds derive truthful references without polluting conversations (57.280209ms)
✔ inline NIP-27 references navigate as typed, explainable evidence without becoming threads (11.927042ms)
✔ replaceable selection and follow interpretation remain stable in one process (26.91925ms)
✔ public local search composes constraints, explains matches, and preserves provenance (28.279042ms)
✔ relation handles resolve references across evidence lifetime and keep bounded views composable (57.001917ms)
✔ large notebook membership is atomic, bounded, process-local, and directly navigable (2341.085833ms)
ℹ tests 23
ℹ suites 0
ℹ pass 23
ℹ fail 0
