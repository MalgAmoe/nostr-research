...
(node:34010) Warning: Setting the NODE_TLS_REJECT_UNAUTHORIZED environment variable to '0' makes TLS connections and HTTPS requests insecure by disabling certificate verification.
(Use `node --trace-warnings ...` to show where the warning was created)
✔ public acquisition handles NIP-01 outcomes, validation, deduplication, provenance, and closure (191.568167ms)
✔ global limit and cancellation are distinguishable and close owned sockets (191.562875ms)
✔ distinct-event budget ignores duplicate observations while observation budget stays hard (52.634083ms)
✔ timeout force-closes a peer that ignores the WebSocket closing handshake (219.465542ms)
✔ timeout and partial connection failure remain observable (138.500875ms)
✔ acquisition rejects unusable public inputs before networking (0.418417ms)
✔ console expansion rejects invalid bounds and semantics before networking (0.54975ms)
...
✔ authored-note expansion samples only explicit account starts within per-account and global bounds (133.011292ms)
✔ authored-note expansion obeys the complete operation budget and stays disabled by default (64.743167ms)
...
✔ bounded reply contexts resolve direct NIP-10 parents with provenance and explicit gaps (124.5125ms)
...
✔ console expansion performs bounded targeted multi-hop acquisition (150.376125ms)
✔ exported expansion uses the global budget for reply breadth and preserves tiny-corpus seeds (101.134166ms)
✔ one console process preserves JavaScript state and composes a bounded research loop (390.316ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (40.414042ms)
✔ process-local memory preserves canonical evidence and independent relay observations (49.852041ms)
✔ presentation and facets orient surviving research values (54.979708ms)
✔ replaceable selection and follow interpretation remain stable in one process (53.974333ms)
✔ public local search composes constraints, explains matches, and preserves provenance (42.528125ms)
✔ current account metadata uses replaceable semantics and profile search returns source evidence (24.092667ms)
✔ large retention is atomic, bounded, process-local, and directly navigable (2442.359042ms)
✔ selection, bounded traversal, projection, retention, and continuation compose (48.8875ms)
✔ public session actions remain temporary while checkpoints remain process-local (33.999458ms)
ℹ tests 22
ℹ suites 0
ℹ pass 22
ℹ fail 0
