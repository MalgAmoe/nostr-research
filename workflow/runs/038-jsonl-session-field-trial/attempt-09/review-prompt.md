...
(node:3461) Warning: Setting the NODE_TLS_REJECT_UNAUTHORIZED environment variable to '0' makes TLS connections and HTTPS requests insecure by disabling certificate verification.
(Use `node --trace-warnings ...` to show where the warning was created)
✔ declarative session preserves handles, revisions, preflight, and partial outcomes (111.392917ms)
✔ public acquisition handles NIP-01 outcomes, validation, deduplication, provenance, and closure (74.976291ms)
✔ account hydration derives a bounded metadata filter from account subjects (31.5815ms)
✔ a named public plan composes bounded acquisition, algebra, hydration, and retention (118.322167ms)
✔ plan preflight rejects retention of value collections before acquisition starts (33.624583ms)
✔ global limit and cancellation are distinguishable and close owned sockets (124.498208ms)
✔ distinct-event budget ignores duplicate observations while observation budget stays hard (113.244666ms)
✔ canonical relay events outside the requested filter are diagnosed without ingestion (64.962917ms)
✔ timeout force-closes a peer that ignores the WebSocket closing handshake (135.71725ms)
✔ timeout and partial connection failure remain observable (125.54ms)
✔ acquisition rejects unusable public inputs before networking (0.383083ms)
✔ console expansion rejects invalid bounds and semantics before networking (0.487625ms)
...
✔ authored-note expansion samples only explicit account starts within per-account and global bounds (115.1585ms)
✔ authored-note expansion obeys the complete operation budget and stays disabled by default (84.633667ms)
✔ expansion reuses distinct capacity when a later request repeats an earlier event (128.656291ms)
...
✔ bounded reply contexts resolve direct NIP-10 parents with provenance and explicit gaps (124.016ms)
...
✔ console expansion performs bounded targeted multi-hop acquisition (59.675125ms)
✔ exported expansion uses the global budget for reply breadth and preserves tiny-corpus seeds (91.507292ms)
✔ typed local stages refine, balance, summarize, and move trial-shaped evidence (44.66225ms)
✔ empty paths retain typed context and invalid plans fail before execution (0.257958ms)
✔ bounded groups expose exact membership, refresh evidence, and summarize exact counts (15.715083ms)
✔ a local-only named plan can query resident memory without implicit acquisition (1.082958ms)
✔ one console process preserves JavaScript state and composes a bounded research loop (297.924ms)
✔ declarative observation and lifecycle form one bounded public workflow (39.534042ms)
✔ declarative show bounds grouped and summarized named results (5.192125ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (35.462042ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (25.94525ms)
✔ JSONL executable provides one persistent bounded process workflow (101.012583ms)
✖ JSONL executable cancels active external work on a termination signal (2086.522792ms)
✔ process-local memory preserves canonical evidence and independent relay observations (34.246041ms)
✔ presentation and facets orient surviving research values (51.843875ms)
✔ replaceable selection and follow interpretation remain stable in one process (52.498958ms)
✔ public local search composes constraints, explains matches, and preserves provenance (29.272584ms)
✔ current account metadata uses replaceable semantics and profile search returns source evidence (17.532125ms)
✔ large retention is atomic, bounded, process-local, and directly navigable (2206.36675ms)
✔ selection, bounded traversal, projection, retention, and continuation compose (31.601666ms)
✔ a session only changes active selection explicitly and checkpoints it process-locally (30.332834ms)
✔ retained reactivation does not recreate evicted canonical evidence (7.584792ms)
ℹ tests 38
ℹ suites 0
ℹ pass 37
ℹ fail 1
...
✖ JSONL executable cancels active external work on a termination signal (2086.522792ms)
  Error: session closure left the relay socket open
      at Timeout.<anonymous> (file:///Users/malg/Documents/Codex/nostr/packages/nostr-research/test/jsonl-session.functional.test.js:187:43)
