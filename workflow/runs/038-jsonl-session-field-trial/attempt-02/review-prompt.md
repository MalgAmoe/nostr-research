...
(node:91021) Warning: Setting the NODE_TLS_REJECT_UNAUTHORIZED environment variable to '0' makes TLS connections and HTTPS requests insecure by disabling certificate verification.
(Use `node --trace-warnings ...` to show where the warning was created)
✔ declarative session preserves handles, revisions, preflight, and partial outcomes (214.354ms)
✔ public acquisition handles NIP-01 outcomes, validation, deduplication, provenance, and closure (69.303584ms)
✔ account hydration derives a bounded metadata filter from account subjects (111.657084ms)
✔ a named public plan composes bounded acquisition, algebra, hydration, and retention (35.748167ms)
✔ plan preflight rejects retention of value collections before acquisition starts (49.308708ms)
✔ global limit and cancellation are distinguishable and close owned sockets (83.129ms)
✔ distinct-event budget ignores duplicate observations while observation budget stays hard (66.7745ms)
✔ canonical relay events outside the requested filter are diagnosed without ingestion (29.485625ms)
✔ timeout force-closes a peer that ignores the WebSocket closing handshake (136.914416ms)
✔ timeout and partial connection failure remain observable (206.871291ms)
✔ acquisition rejects unusable public inputs before networking (0.395875ms)
✔ console expansion rejects invalid bounds and semantics before networking (0.656333ms)
...
✔ authored-note expansion samples only explicit account starts within per-account and global bounds (115.660833ms)
✔ authored-note expansion obeys the complete operation budget and stays disabled by default (65.480584ms)
✔ expansion reuses distinct capacity when a later request repeats an earlier event (75.597209ms)
...
✔ bounded reply contexts resolve direct NIP-10 parents with provenance and explicit gaps (112.3025ms)
...
✔ console expansion performs bounded targeted multi-hop acquisition (73.708042ms)
✔ exported expansion uses the global budget for reply breadth and preserves tiny-corpus seeds (99.588375ms)
✔ typed local stages refine, balance, summarize, and move trial-shaped evidence (43.534209ms)
✔ empty paths retain typed context and invalid plans fail before execution (0.282292ms)
✔ bounded groups expose exact membership, refresh evidence, and summarize exact counts (12.674542ms)
✔ a local-only named plan can query resident memory without implicit acquisition (0.590125ms)
✔ one console process preserves JavaScript state and composes a bounded research loop (318.5975ms)
✔ declarative observation and lifecycle form one bounded public workflow (54.751042ms)
✔ declarative show bounds grouped and summarized named results (4.62025ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (32.63075ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (19.741125ms)
✔ JSONL executable provides one persistent bounded process workflow (85.538417ms)
✖ JSONL executable cancels active external work on a termination signal (2089.186875ms)
✔ process-local memory preserves canonical evidence and independent relay observations (32.136666ms)
✔ presentation and facets orient surviving research values (57.219709ms)
✔ replaceable selection and follow interpretation remain stable in one process (60.020834ms)
✔ public local search composes constraints, explains matches, and preserves provenance (27.076375ms)
✔ current account metadata uses replaceable semantics and profile search returns source evidence (17.349167ms)
✔ large retention is atomic, bounded, process-local, and directly navigable (2199.897084ms)
✔ selection, bounded traversal, projection, retention, and continuation compose (34.426875ms)
✔ a session only changes active selection explicitly and checkpoints it process-locally (35.818666ms)
✔ retained reactivation does not recreate evicted canonical evidence (7.420417ms)
ℹ tests 38
ℹ suites 0
ℹ pass 37
ℹ fail 1
