...
(node:952) Warning: Setting the NODE_TLS_REJECT_UNAUTHORIZED environment variable to '0' makes TLS connections and HTTPS requests insecure by disabling certificate verification.
(Use `node --trace-warnings ...` to show where the warning was created)
✔ declarative session preserves handles, revisions, preflight, and partial outcomes (136.160125ms)
✔ public acquisition handles NIP-01 outcomes, validation, deduplication, provenance, and closure (52.366125ms)
✔ account hydration derives a bounded metadata filter from account subjects (85.883667ms)
✔ a named public plan composes bounded acquisition, algebra, hydration, and retention (65.663208ms)
✔ plan preflight rejects retention of value collections before acquisition starts (57.598875ms)
✔ global limit and cancellation are distinguishable and close owned sockets (94.92075ms)
✔ distinct-event budget ignores duplicate observations while observation budget stays hard (48.480791ms)
✔ canonical relay events outside the requested filter are diagnosed without ingestion (73.88625ms)
✔ timeout force-closes a peer that ignores the WebSocket closing handshake (207.519625ms)
✔ timeout and partial connection failure remain observable (136.019708ms)
✔ acquisition rejects unusable public inputs before networking (0.385792ms)
✔ console expansion rejects invalid bounds and semantics before networking (0.483458ms)
...
✔ authored-note expansion samples only explicit account starts within per-account and global bounds (68.691917ms)
✔ authored-note expansion obeys the complete operation budget and stays disabled by default (124.2995ms)
✔ expansion reuses distinct capacity when a later request repeats an earlier event (66.505625ms)
...
✔ bounded reply contexts resolve direct NIP-10 parents with provenance and explicit gaps (135.222083ms)
...
✔ console expansion performs bounded targeted multi-hop acquisition (92.301375ms)
✔ exported expansion uses the global budget for reply breadth and preserves tiny-corpus seeds (143.759167ms)
✔ typed local stages refine, balance, summarize, and move trial-shaped evidence (39.128375ms)
✔ empty paths retain typed context and invalid plans fail before execution (0.271541ms)
✔ bounded groups expose exact membership, refresh evidence, and summarize exact counts (13.477584ms)
✔ a local-only named plan can query resident memory without implicit acquisition (0.574083ms)
✔ one console process preserves JavaScript state and composes a bounded research loop (304.695042ms)
✔ declarative observation and lifecycle form one bounded public workflow (40.926833ms)
✔ declarative show bounds grouped and summarized named results (2.138791ms)
✔ mixed ingestion and FIFO eviction leave coherent public indexes and source edges (24.2195ms)
✔ collections re-resolve stable subjects across observations, replacement metadata, and eviction (25.838083ms)
✔ JSONL executable provides one persistent bounded process workflow (105.774875ms)
✖ JSONL executable cancels active external work on a termination signal (2089.799667ms)
✔ process-local memory preserves canonical evidence and independent relay observations (35.301916ms)
✔ presentation and facets orient surviving research values (48.010709ms)
✔ replaceable selection and follow interpretation remain stable in one process (57.70075ms)
✔ public local search composes constraints, explains matches, and preserves provenance (29.8535ms)
✔ current account metadata uses replaceable semantics and profile search returns source evidence (19.714625ms)
✔ large retention is atomic, bounded, process-local, and directly navigable (2218.619125ms)
✔ selection, bounded traversal, projection, retention, and continuation compose (30.958208ms)
✔ a session only changes active selection explicitly and checkpoints it process-locally (34.978ms)
✔ retained reactivation does not recreate evicted canonical evidence (6.138459ms)
ℹ tests 38
ℹ suites 0
ℹ pass 37
ℹ fail 1
